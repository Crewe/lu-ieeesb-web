...
-->        
            <div class="feature-grid">
                <div class="block-a">
                    <h2>Electrical</h2>
                    <p>Circuit theory, transistors, power systems</p>
                </div>
                <div class="block-b">
                    <h2>Software</h2>
                    <p>C/C++, Architecture, Design Patterns, development.</p>
                </div>
                <div class="block-c">
			...
			<p>
				Through its technical publishing, conferences and  consensus-based standards activities, the IEEE produces 30 percent of the world's published literature in electrical engineering, computers and control technology, holds annually
				more than 300 major conferences and has nearly 900 active standards with 700 under development.
			</p>
			...
			<p>
				The <a href="downloads/constitution.pdf">branch constitution</a> has been formed and approved at the meeting of February 27, 2009. 
			</p>
